...
class formMoFile(tk.Toplevel):
    def __init__(self, parent):
        ...
        openDS_btn = Button(self, text="DanhSach.txt", activebackground="#42a5f5", width=12, height=1, command=open_DS)
        openDS_btn.place(x=40, y=500)
        openCTDT_btn = Button(self, text="ChiTietDT.txt", activebackground="#42a5f5", width=12, height=1, command=open_CTDT)
        openCTDT_btn.place(x=160, y=500)
        openDT_btn = Button(self, text="DiemThi.txt", activebackground="#42a5f5", width=12, height=1, command=open_DT)
